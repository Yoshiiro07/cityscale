...
import com.badlogic.gdx.graphics.g2d.TextureAtlas;
	...
	private TextureAtlas atlas_weapon_global;
	...
	public DataManager() {
		...
		atlas_weapon_global = new TextureAtlas(Gdx.files.internal("data/itens/weapons/nknifes.txt"));
	...
	public Sprite ReturnHairs(String hairName, String side, String walk, String text, boolean inBattle, boolean isCasting, Player Character_Data, float posX, float posY){
		...
		public Sprite ShowWeapon(String side,String walk, String type, float posX, float posY, Player Character_Data, boolean inBattle, boolean attackFrame, int playerbattleframe) {
			if(inBattle && walk.equals("Stop") && !type.equals("Menu")) {
				...
				if(text.equals("yes_Right")) { sideType = "right";}
				if(text.equals("yes_Left")) { sideType = "left";}
				//Novice | Swordman | Beater
				if(Character_Data.Job_A.equals("Novice") || Character_Data.Job_A.equals("Swordman") || Character_Data.Job_A.equals("Beater")
					|| Character_Data.Job_A.equals("Gunner") || Character_Data.Job_A.equals("Thief")	) {
					
					if(Character_Data.Job_A.equals("Novice")) { atlas_weapon_global = atlas_nKnifes;}
					if(Character_Data.Job_A.equals("Swordman")) { atlas_weapon_global = atlas_swords;}
					if(Character_Data.Job_A.equals("Beater")) { atlas_weapon_global = atlas_axes;}
					if(Character_Data.Job_A.equals("Gunner")) { atlas_weapon_global = atlas_pistols;}
					if(Character_Data.Job_A.equals("Thief")) { atlas_weapon_global = atlas_daggers;}
					
					if(attackFrame) {
						spr_master = atlas_weapon_global.createSprite(weapon + "_attack_" + sideType);
						spr_master.setSize(30,37); 
						if(sideType.equals("right")) { spr_master.setPosition(posX + 8.9f, posY + 17); }
						if(sideType.equals("left")) { spr_master.setPosition(posX + 8.9f, posY + 17); }
						return spr_master;
					}
					if(playerbattleframe == 1 || playerbattleframe == 6) {
						spr_master = atlas_weapon_global.createSprite(weapon + "_" + sideType);
						spr_master.setSize(30,37);
						if(sideType.equals("right")) { spr_master.setPosition(posX - 11.9f, posY + 26); }
						if(sideType.equals("left")) { spr_master.setPosition(posX + 8.9f, posY + 17); }
						return spr_master;
					}
					...
					if(playerbattleframe == 2 || playerbattleframe == 5) {
						spr_master = atlas_weapon_global.createSprite(weapon + "_" + sideType);
						spr_master.setSize(30,37);
						if(sideType.equals("right")) { spr_master.setPosition(posX - 11f, posY + 30);}
						if(sideType.equals("left")) { spr_master.setPosition(posX + 8.9f, posY + 17); }
						return spr_master;
					}
					
					if(playerbattleframe == 3 || playerbattleframe == 4) {
						spr_master = atlas_weapon_global.createSprite(weapon + "_side_" + sideType);
						spr_master.setSize(25,39);
						if(sideType.equals("right")) { spr_master.setPosition(posX - 5f, posY + 30); }
						if(sideType.equals("left")) { spr_master.setPosition(posX + 8.9f, posY + 17); }
						return spr_master;
					}								
				}	
				...
				if(Character_Data.Job_A.equals("Magician") || Character_Data.Job_A.equals("Medic")) {
					if(attackFrame) {
						spr_master = atlas_rods.createSprite(weapon + "_" + sideType);
						spr_master.setSize(30,37); 
						if(sideType.equals("right")) { spr_master.setPosition(posX + 8.2f, posY + 35); }
						if(sideType.equals("left")) { spr_master.setPosition(posX - 16f, posY + 35); }
						return spr_master;
					}
					if(playerbattleframe == 1 || playerbattleframe == 6) {
						spr_master = atlas_rods.createSprite(weapon + "_" + sideType);
						spr_master.setSize(30,37);
						if(sideType.equals("right")) { spr_master.setPosition(posX, posY + 20); }
						if(sideType.equals("left")) { spr_master.setPosition(posX - 7.5f, posY + 20); }
						return spr_master;
					}
